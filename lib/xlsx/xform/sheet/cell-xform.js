...
class CellXform extends BaseXform {
  ...
  reconcile(model, options) {
    ...
    switch (model.type) {
      ...
      case Enums.ValueType.Formula:
        // string results (t="str") must not be converted to dates even when the
        // cell style has a date numFmt — excelToDate on a string yields an
        // Invalid Date that serialises as <v>NaN</v> and corrupts the workbook
        if (typeof model.result === 'number' && style && utils.isDateFmt(style.numFmt)) {
